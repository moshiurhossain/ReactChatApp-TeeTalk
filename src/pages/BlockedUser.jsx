...
console.log(blockUser)
  return (
    ...
    <div className=' p-6 gap-5'>
      ...
      <div className='blockuserCard m-3 flex justify-between items-center w-[400px] py-2 h-fit px-3 rounded-[5px] shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]'>
